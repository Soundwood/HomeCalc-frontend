...
const ScenarioAnalysisFiveX = (props) => {
    const max_home_price = props.scenario.net_income*5
    ...
    return (
        <>
            <h2>5X Rule Home Purchase Analysis</h2> 
            <h4>This rule states that the home should cost no more than 5 times Gross Income. The rule is for people who have NO 
                other debt such as car payments, credit card debt, or student loans.
            </h4>
...
export default ScenarioAnalysisFiveX