...
const ScenarioAnalysisFourX = (props) => {
    const max_home_price = props.scenario.net_income*4
    ...
    return (
        <>
            <h2>4X Rule Home Purchase Analysis</h2> 
            <h4>This rule states that the home should cost no more than 4 times Gross Income. The rule is for people spending less than 20%
                 of their income on other debt such as car payments, credit card debt, or student loans.
            </h4>
...
export default ScenarioAnalysisFourX